package com.bhx.masterbean.model.article;
...
public class ArticleDetailModel {
    ...
    public void setH_coin(String h_coin) {
        this.h_coin = h_coin;
    }
    ...
    public int getClick_sta() {
        return click_sta;
    }

    public void setClick_sta(int click_sta) {
        this.click_sta = click_sta;
    }
